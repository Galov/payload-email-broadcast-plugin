...
Версия `1.0.1` използва production модел с Resend Contacts, постоянни Segments и Broadcasts. Реалните кампании не се изпращат като отделни transactional имейли.
...
```bash
pnpm add github:Galov/payload-email-broadcast-plugin#v1.0.1
```
