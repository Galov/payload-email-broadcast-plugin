...
1. Payload избира аудиторията.
2. Payload създава или обновява Resend Contacts.
3. Payload създава Resend Segment за конкретната кампания или избира вече свързан segment.
4. Payload добавя получателите към segment-а.
5. Payload създава Resend Broadcast към този segment.
6. Resend изпраща Broadcast-а.
...
Payload recipient mode-ът се материализира като Resend Segment.

Първата версия трябва да създава отделен segment за всяка реална кампания. Това е най-проследимо и избягва риск от промяна на аудиторията след потвърждение.
...
- Режим `all` се разрешава едва след доказан Resend Broadcast flow.
