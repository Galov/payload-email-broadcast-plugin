...
3. Payload използва предварително конфигуриран постоянен Resend Segment.
4. Payload добавя или маха получателите от segment-а при запис на recipient документа.
5. Payload създава Resend Broadcast към избрания segment.
